...
- [Configuration Guide](../getting-started/configuration.md) - Detailed configuration walkthrough
- [CLI Reference](../developer-guide/3-reference/cli.md) - Using `brainsmith project` commands
- [Component Registry](registry.md) - Understanding component discovery
