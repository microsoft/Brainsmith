...
# Generation timestamp: 2025-06-16T22:40:14.932426
#
...
def make_thresholding_axi_node(inputs, outputs, **node_attrs):
    ...
    required_algorithm_params = [p for p in ['N', 'WI', 'WT', 'C', 'SIGNED', 'FPARG', 'THRESHOLDS_PATH', 'USE_AXILITE', 'DEPTH_TRIGGER_URAM', 'DEPTH_TRIGGER_BRAM', 'DEEP_PIPELINE'] if p not in ['WI', 'FPARG', 'BIAS', 'SIGNED', 'O_BITS']]
