...
# Generation timestamp: 2025-06-16T23:16:45.939935
#
...
class ThresholdingAxi(AutoHWCustomOp):
    ...
    Generated from RTL: brainsmith/hw_kernels/thresholding/thresholding_axi.sv
    ...
    def __init__(self, onnx_node, **kwargs):
        ...
        self.rtl_source = "brainsmith/hw_kernels/thresholding/thresholding_axi.sv"
    ...
    def get_nodeattr_types(self) -> Dict[str, Tuple[str, bool, Any]]:
        ...
        my_attrs["s_axisDataType"] = ('s', False, 'INT8')  # input interface datatype
        my_attrs["m_axisDataType"] = ('s', False, 'INT8')  # output interface datatype
...
def make_thresholding_axi_node(inputs, outputs, **node_attrs):
    ...
    - s_axisDataType: str = "INT8"  # input interface datatype
    - m_axisDataType: str = "INT8"  # output interface datatype
    ...
    required_algorithm_params = [p for p in ['N', 'WI', 'WT', 'C', 'SIGNED', 'FPARG', 'THRESHOLDS_PATH', 'USE_AXILITE', 'DEPTH_TRIGGER_URAM', 'DEPTH_TRIGGER_BRAM', 'DEEP_PIPELINE'] if p not in ['SIGNED_M_AXIS', 'BIAS', 'O_BITS', 'SIGNED', 'WI', 'FPARG']]
