...
############################################################################
"""Tests for OrderedParameter class."""
...
def test_ordered_dimension_with_default():
    """Test OrderedParameter with explicit default."""
    dim = OrderedParameter("depth", (128, 256, 512, 1024), default=256)
...
def test_ordered_dimension_default_is_min():
    ...
    dim = OrderedParameter("PE", (1, 2, 4, 8, 16, 32))
...
def test_at_index_out_of_range():
    ...
    dim = OrderedParameter("test", (1, 2, 4))
...
def test_step_up():
    ...
    dim = OrderedParameter("PE", (1, 2, 4, 8, 16, 32, 64))
...
def test_len():
    """Test __len__() method."""
    dim = OrderedParameter("test", (1, 2, 4, 8, 16))
...
def test_repr_short():
    ...
    assert repr(dim) == "OrderedParameter('PE', (1, 2, 4, 8))"


def test_repr_long():
    """Test __repr__() for long value lists."""
    dim = OrderedParameter("SIMD", (1, 2, 4, 8, 16, 32, 64, 128))

    # Long lists show first, second, and last
    assert "OrderedParameter('SIMD', (1, 2, ..., 128))" == repr(dim)


def test_repr_with_default():
    """Test __repr__() with explicit default."""
    dim = OrderedParameter("depth", (128, 256, 512), default=256)
...
def test_two_value_dimension():
    ...
    dim = OrderedParameter("test", (1, 10))
...
def test_large_dimension():
    ...
    dim = OrderedParameter("SIMD", divisors_768)
...
def test_immutability():
    """Test that OrderedParameter is immutable (frozen dataclass)."""
    dim = OrderedParameter("test", (1, 2, 4, 8))
