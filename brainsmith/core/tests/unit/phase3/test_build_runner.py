...
from brainsmith.core.phase3.data_structures import BuildStatus, BuildMetrics, BuildResult
from brainsmith.core.phase3.build_runner import BuildRunner
from brainsmith.core.phase3.interfaces import BuildRunnerInterface
...
class TestBuildRunner:
    ...
    @patch('brainsmith.core.phase3.build_runner.PreprocessingPipeline')
    @patch('brainsmith.core.phase3.build_runner.PostprocessingPipeline')
