...
@dataclass
class DSEResults:
    """Enhanced results container for DSE."""
    ...
    def dominates(self, other: 'DSEResults', objectives: List[str],
...
class ParetoFrontierAnalyzer:
    ...
    def _find_pareto_frontier(self, results: List[DSEResults],
                            objectives: List[str],
                            directions: List[str]) -> List[DSEResults]:
