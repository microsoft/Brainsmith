...
# Date: 2025-07-02T23:00:22.724610
...
class thresholding_axi_rtl(ThresholdingAxi, AutoRTLBackend):
    ...
    def get_nodeattr_types(self):
        ...
        # Note: Made most attributes optional with defaults for testing
        rtl_attrs = {
            "input_FPARG": ('i', False, 8),  # Default input fixed-point width
            "BIAS": ('i', False, 0),  # Default bias value
            "THRESHOLDS_PATH": ('s', False, ''),
            "USE_AXILITE": ('i', False, 0),  # Default: no AXI-lite
            "DEPTH_TRIGGER_URAM": ('i', False, 1024),  # Default URAM depth trigger
            "DEPTH_TRIGGER_BRAM": ('i', False, 512),   # Default BRAM depth trigger
            "DEEP_PIPELINE": ('i', False, 0),  # Default: no deep pipeline
