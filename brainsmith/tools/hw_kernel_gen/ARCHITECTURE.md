# Hardware Kernel Generator Architecture
...
### Basic Generation
```bash
./smithy exec "python -m brainsmith.tools.hw_kernel_gen mykernel.sv"
```

### With Custom Output
```bash
./smithy exec "python -m brainsmith.tools.hw_kernel_gen mykernel.sv -o /custom/path"
```

### Multi-Module Files
```bash
./smithy exec "python -m brainsmith.tools.hw_kernel_gen complex.sv -m specific_module"
```
