...
############################################################################
"""
Utility functions for Hardware Kernel Generator.

This module contains common utility functions used throughout the HW Kernel
Generator to reduce code duplication and provide consistent behavior.
"""
