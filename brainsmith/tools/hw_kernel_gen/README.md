...
The Hardware Kernel Generator automatically creates FINN-compatible Python wrappers from SystemVerilog RTL kernels using pragma-driven analysis.
...
# Example
./smithy exec "python -m brainsmith.tools.hw_kernel_gen tests/test_kernel_e2e.sv -o output/"
```

## Generated Files

For each kernel, HWKG generates three complementary files:
