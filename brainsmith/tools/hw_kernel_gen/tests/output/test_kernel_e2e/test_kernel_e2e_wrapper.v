...
// Date: 2025-06-30T15:25:57.567117
...
module test_kernel_e2e_wrapper #(    // General algorithm parameters
    ...
    parameter OUTPUT_BDIM = $OUTPUT_BDIM$,
    parameter OUTPUT_WIDTH = $OUTPUT_WIDTH$,
    // s_axis_weights interface parameters
    parameter WEIGHT_BDIM = $WEIGHT_BDIM$,
    parameter WEIGHT_SDIM = $WEIGHT_SDIM$,
    ...
    test_kernel_e2e #(        // General algorithm parameters
        ...
        // m_axis_output interface parameters
        .OUTPUT_BDIM(OUTPUT_BDIM),
        .OUTPUT_WIDTH(OUTPUT_WIDTH),
        // s_axis_weights interface parameters
        .WEIGHT_BDIM(WEIGHT_BDIM),
        .WEIGHT_SDIM(WEIGHT_SDIM),
        .WEIGHT_WIDTH(WEIGHT_WIDTH),
        .WEIGHT_SIGNED(WEIGHT_SIGNED)    ) test_kernel_e2e_inst (
        // Global control
        .ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
        .ap_start(ap_start),
