...
# Date: 2025-06-20T21:53:32.380035

from brainsmith.dataflow.core.auto_rtl_backend import AutoRTLBackend


class test_axilite_suffix_rtl(AutoRTLBackend):
    """RTL backend for test_axilite_suffix operation.
    
    Auto-generated from SystemVerilog RTL analysis.
    
    Hardware accelerator operation: test_axilite_suffix
    """
    ...
    def get_nodeattr_types(self):
        ...
        my_attrs["CONFIG_AXILITE"] = ("i", False, 1)
        # Algorithm parameter - optional with default
        my_attrs["DEBUG_EN"] = ("i", False, 1)
        # Algorithm parameter - optional with default
        my_attrs["MONITOR_EN"] = ("i", False, 1)
        # Algorithm parameter - optional with default
        my_attrs["NORMAL_PARAM"] = ("i", False, 1)
    ...
    def prepare_codegen_rtl_values(self, model):
        ...
        code_gen_dict["$CONFIG_AXILITE$"] = [str(self.get_nodeattr("CONFIG_AXILITE"))]
        code_gen_dict["$DEBUG_EN$"] = [str(self.get_nodeattr("DEBUG_EN"))]
        code_gen_dict["$MONITOR_EN$"] = [str(self.get_nodeattr("MONITOR_EN"))]
        code_gen_dict["$NORMAL_PARAM$"] = [str(self.get_nodeattr("NORMAL_PARAM"))]
        ...
        for interface in interface_metadata:
            ...
            if hasattr(interface, 'bdim_param') and interface.bdim_param:
                bdim_value = self.get_nodeattr(interface.bdim_param) if interface.bdim_param in ['CONFIG_AXILITE', 'DEBUG_EN', 'MONITOR_EN', 'NORMAL_PARAM'] else None
            ...
            if hasattr(interface, 'sdim_param') and interface.sdim_param:
                sdim_value = self.get_nodeattr(interface.sdim_param) if interface.sdim_param in ['CONFIG_AXILITE', 'DEBUG_EN', 'MONITOR_EN', 'NORMAL_PARAM'] else None
    ...
    def get_supporting_rtl_files(self) -> list:
        ...
        return [
            "test_axilite_suffix_axi.sv",
            "test_axilite_suffix.sv",
        ]
