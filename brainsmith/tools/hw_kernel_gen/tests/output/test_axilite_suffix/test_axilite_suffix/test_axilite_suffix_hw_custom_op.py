...
#
# Auto-generated HWCustomOp for test_axilite_suffix
# Generated from: brainsmith/tools/hw_kernel_gen/tests/test_axilite_suffix.sv
# Generation timestamp: 2025-06-20T21:53:32.363797
#
...
class TestAxiliteSuffix(AutoHWCustomOp):
    """
    Auto-generated HWCustomOp for test_axilite_suffix kernel.
    
    Generated from RTL: brainsmith/tools/hw_kernel_gen/tests/test_axilite_suffix.sv
    ...
    def __init__(self, onnx_node, **kwargs):
        """Initialize TestAxiliteSuffix following FINN's standard pattern."""
        super().__init__(onnx_node, **kwargs)
        
        # Set kernel-specific attributes
        self.kernel_name = "test_axilite_suffix"
        self.rtl_source = "brainsmith/tools/hw_kernel_gen/tests/test_axilite_suffix.sv"
    ...
    def get_nodeattr_types(self) -> Dict[str, Tuple[str, bool, Any]]:
        ...
        my_attrs["CONFIG_AXILITE"] = ("i", True, None)  # Required parameter
        my_attrs["DEBUG_EN"] = ("i", True, None)  # Required parameter
        my_attrs["MONITOR_EN"] = ("i", True, None)  # Required parameter
        my_attrs["NORMAL_PARAM"] = ("i", True, None)  # Required parameter
    ...
    def bram_estimation(self) -> int:
        """Estimate BRAM usage for test_axilite_suffix."""
        return 1
    
    def lut_estimation(self) -> int:
        """Estimate LUT usage for test_axilite_suffix."""
        return 2000
    
    def dsp_estimation(self) -> int:
        """Estimate DSP usage for test_axilite_suffix."""
        return 0
    


# Convenience function for FINN integration
def make_test_axilite_suffix_node(inputs, outputs, **node_attrs):
    """
    Create TestAxiliteSuffix ONNX node.
    ...
    required_algorithm_params = [p for p in ['INPUT_WIDTH', 'OUTPUT_WIDTH', 'CONFIG_AXILITE', 'DEBUG_EN', 'MONITOR_EN', 'NORMAL_PARAM'] if p in ['CONFIG_AXILITE', 'DEBUG_EN', 'MONITOR_EN', 'NORMAL_PARAM']]
