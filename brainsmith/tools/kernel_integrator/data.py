...
############################################################################
"""
Shared data structures for Kernel Integrator.
...
# Import constraint types from core to avoid circular dependency
...
# InterfaceType has been moved to brainsmith.core.dataflow.types
