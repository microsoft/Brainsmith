"""
Transformer-specific graph surgery operations like head/tail removal.
"""
...
@register_step(
    ...
    description="Remove all nodes up to the first LayerNormalization node and rewire the input"
)
def remove_head_step(model, cfg):
    """Remove all nodes up to the first LayerNormalization node and rewire the input."""
