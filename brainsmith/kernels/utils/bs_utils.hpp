...
// NOTE: The following utilities are now provided by finn-hlslib/utils.hpp:
// - std::numeric_limits<ap_uint<W>>
// - std::numeric_limits<ap_int<W>>
// - flit_t<T>
// - move(hls::stream<T> &src, hls::stream<T> &dst)
//
// These definitions have been removed to avoid redefinition conflicts.
// Include finn-hlslib/utils.hpp (via bnn-library.h) to use these utilities.
