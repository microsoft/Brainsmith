...
def test_auto_layernorm_node_attributes():
    ...
    assert "inputDataType" in attr_names, "inputDataType attribute missing"
    assert "outputDataType" in attr_names, "outputDataType attribute missing"
    ...
    odt_val = helper.get_node_attr_value(node, "outputDataType")
    ...
    assert idt_val == datatype, f"inputDataType should be {datatype}, got {idt_val}"
    assert odt_val == datatype, f"outputDataType should be {datatype}, got {odt_val}"
    ...
    print(f"    - inputDataType: {helper.get_node_attr_value(node, 'inputDataType')}")
    print(f"    - outputDataType: {helper.get_node_attr_value(node, 'outputDataType')}")
