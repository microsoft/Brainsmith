...
class LegacyShuffle(HWCustomOp):
    """Legacy Shuffle implementation (manual HWCustomOp).

    This is the original Shuffle implementation using manual nodeattr storage.
    For new code, use the modern Shuffle class from shuffle.py instead.
    """
