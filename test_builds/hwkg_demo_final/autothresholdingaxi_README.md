...
**Source RTL:** `examples/thresholding/thresholding_axi.sv`
**Generated Classes:**
...
- **s_axis**
  ...
  - Dimensions: qDim=[16], tDim=[8], stream_dims=[1]
  - Data Type: UINT8
...
- **s_axilite**
  ...
  - Dimensions: qDim=[1], tDim=[1], stream_dims=[1]
  - Data Type: UINT32
...
hw_op.set_nodeattr("m_axis_dtype", "UINT8")
