...
from brainsmith.tools.hw_kernel_gen.rtl_parser import RTLParser, HWKernel, Parameter, Port, Direction, Interface, InterfaceType # Import necessary classes
...
TEMPLATE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../brainsmith/tools/hw_kernel_gen/templates"))
...
def kernel_no_params():
    ...
    return HWKernel(
        ...
        interfaces={ # Dummy interfaces
            "in0": Interface(name="in0", type=InterfaceType.AXI_STREAM, direction=Direction.INPUT, ports=[], width="32"),
            "out0": Interface(name="out0", type=InterfaceType.AXI_STREAM, direction=Direction.OUTPUT, ports=[], width="32"),
            "ap_clk": Interface(name="ap_clk", type=InterfaceType.GLOBAL, direction=Direction.INPUT, ports=[], width="1"),
            "ap_rst_n": Interface(name="ap_rst_n", type=InterfaceType.GLOBAL, direction=Direction.INPUT, ports=[], width="1"),
        },
        pragmas=[],
        metadata={}
    )
