...
class ThresholdingAxi_rtl(ThresholdingAxi, AutoRTLBackend):
    ...
    def get_included_rtl_filenames(self) -> List[str]:
        ...
        return [
            os.path.basename("/home/tafk/dev/brainsmith-1/examples/kernel_integrator/source/thresholding_axi.sv"),
            os.path.basename("thresholding.sv"),
            os.path.basename("/home/tafk/dev/brainsmith-1/deps/finn/finn-rtllib/axi/hdl/axilite.sv"),
        ]
    ...
    def generate_hdl(self, model, fpgapart, clk):
        ...
        included_files = ['/home/tafk/dev/brainsmith-1/examples/kernel_integrator/source/thresholding_axi.sv', 'thresholding.sv', '/home/tafk/dev/brainsmith-1/deps/finn/finn-rtllib/axi/hdl/axilite.sv']
