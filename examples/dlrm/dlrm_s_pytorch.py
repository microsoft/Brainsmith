...
from brevitas.quant import Int8WeightPerTensorFloat, Uint8ActPerTensorFloat, Int8Bias
...
class DLRM_Net(nn.Module):
    def create_mlp(self, ln, sigmoid_layer):
        ...
        for i in range(0, ln.size - 1):
            ...
            LL = QuantLinear(int(n), int(m), bias=True, weight_quant=Int8WeightPerTensorFloat, input_quant=Uint8ActPerTensorFloat, bias_quant=Int8Bias)
