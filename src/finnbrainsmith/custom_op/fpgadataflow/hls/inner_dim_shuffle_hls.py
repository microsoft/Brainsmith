...
from finnbrainsmith.transformation.shuffle_helpers import simplify_transpose, calculate_wr_rot_period, ParallelInnerShuffle 
...
class InnerDimShuffle_hls(Shuffle, BS_HLSBackend):
    def __init__(self, onnx_node, **kwargs):
        ...
        self.shuffle_model = ParallelInnerShuffle(self.shape, self.perm, self.simd, self._relax)
