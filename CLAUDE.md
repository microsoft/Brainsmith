...
Always use the unified `InterfaceType` from `brainsmith.dataflow.core.interface_types`. The old dual type system (RTLInterfaceType/DataflowInterfaceType) has been removed.
