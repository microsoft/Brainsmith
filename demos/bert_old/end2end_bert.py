...
def main(args):
    ...
    # Save initial model for comparison with modern demo
    debug_dir = os.path.join(os.environ.get("BSMITH_BUILD_DIR", "."), args.output, "debug_models")
    os.makedirs(debug_dir, exist_ok=True)
    onnx.save(model, os.path.join(debug_dir, "00_old_initial_brevitas.onnx"))
    print(f"Saved old demo initial model to {debug_dir}/00_old_initial_brevitas.onnx")
